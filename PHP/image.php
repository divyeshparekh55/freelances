            ...
            if ($error === 0) {
                if ($img_size > 1250000) {
                    ...
                    if (in_array($img_ex_lc, $allowed_exs)) {
                        ...
                        $sql = "INSERT INTO upload_image(user_id,category_id,img_nme,img_path) VALUES ('$admin_id','$ctgy_id','$new_img_name','$img_upload_path')";
...
<script>
    <?php
        ...
        $users = $db->select('upload_image',['*'],['category_id'=>$ctgy_id,'user_id'=>$admin_id])->results();
